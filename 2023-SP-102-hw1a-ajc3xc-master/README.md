...
Students should submit their written assignments as a pdf document with the title "hw1a-sol.pdf" (either a scanned copy of hand-written version, or created using the provided LaTeX template), with the name written on the top left corner of the first page.  Also, each programming assignment should be submitted as an independent Jupyter notebook, labeled as "<student_last_name>-hw1a-<problem_number>.ipynb". Please follow the Insertion Sort template provided in the class to package your code.

# Instructions for Cloning hw1a folder
...
```
$ git clone https://git-classes.mst.edu/2023-SP-CS2500-102/<repository_name>.git
```
